...
__fastcall TInfoDonor::TInfoDonor(TComponent* Owner)
	: TForm(Owner)
{
	//початкові налаштування компонентів форми
    //та вивід інформації про сумісність крові
	SGRec->Width=150;
	SGRec->Height=90;
	SGRec->ColWidths[0]=150;
	SGRec->RowHeights[0]=90;
	SGRec->Cells[0][0]="Реціпієнт";

	SGRecGroups->Width=90;
	SGRecGroups->Height=250;
	SGRecGroups->ColWidths[0]=90;
	SGRecGroups->DefaultRowHeight=60;
	SGRecGroups->Cells[0][0]="IV група";
	SGRecGroups->Cells[0][1]="II група";
	SGRecGroups->Cells[0][2]="III група";
	SGRecGroups->Cells[0][3]="I група";
	...
	SGDon->Cells[0][0]="Донор";

	SGDonGroups->Width=480;
	SGDonGroups->Height=30;
	SGDonGroups->RowHeights[0]=30;
	SGDonGroups->DefaultColWidth=120;
	SGDonGroups->Cells[0][0]="I група";
	SGDonGroups->Cells[1][0]="III група";
	SGDonGroups->Cells[2][0]="II група";
	SGDonGroups->Cells[3][0]="IV група";
